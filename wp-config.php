...
define('DB_NAME', 'dctwebwp');

/** MySQL 資料庫使用者名稱，請更改 "username_here" */
define('DB_USER', 'dctwebmaster');

/** MySQL 資料庫密碼，請更改 "password_here" */
define('DB_PASSWORD', 'nccudct1233211234567!@#!@#!@#');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         '/iGlj@3+2lJe1{MAen3p#icXdDXY-wKV7d$B?B4:6$?;}wy&1x41? |1l~OR^4&9');
define('SECURE_AUTH_KEY',  '$CQtDJ4u4|fXhc{*VuhQ{b+Dn4IkFhROdT-b/vHGGb#F:JIP&>$l*UXY;F+|?2PM');
define('LOGGED_IN_KEY',    '_qXpHdeejIf3_n|{Pm:w.`2==n_,?@s{[@B}W[,<0iRyf#e2&+}5|=Z8IW*D(= c');
define('NONCE_KEY',        '>$;%HG01_ICQ6:C_3N|~yEZQAYjgzeC}WOfSj9c]C9Ep`Nl<S5b5y`)|(:!?np9c');
define('AUTH_SALT',        'p>DmM r4!Q7)vtE`<U:.;EC6RgW9r#T9W@Qq)#r>-S`UEnU#t|kCz$E7n6O-hVrl');
define('SECURE_AUTH_SALT', ')]vy1ix_h4}cSF3J+5&i9AUC;~{&:K]k&5k%XVYnO8 .ehEK]cT<}}wv{+}`,eP,');
define('LOGGED_IN_SALT',   'ih+&q99dbm&Mp_u1`!1ttG1=IJN^-<QNbbQR6z_$<:u$|Skl 7^Gi@H^7-C>$J/o');
define('NONCE_SALT',       '$phE_b2uM>W(D#{qbH0kgs.bH$OAO .<c !^)>h^6(j+xO|_@m(46C=-rJyUq<e~');
